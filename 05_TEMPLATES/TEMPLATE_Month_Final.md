...
> Outcome = đo được (không phải to-do). Outcome được chọn nên phản ánh strategic alignment + impact, không chỉ urgency.
...
> **What this is:** Tactical direction for each week, distilled from monthly scope.
> Week Seeds are **not a task list**. Do not add subtasks or checklists here.
> Each Seed is used to generate the Week Mission (week plan). Tasks are broken down inside the week plan.
...
> If the month spans 5 weeks, add a Week 5 seed as needed — not required by default.
