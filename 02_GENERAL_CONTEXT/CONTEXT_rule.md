...
- [0) Nguyên tắc gốc](#0-nguyên-tắc-gốc)
- [1) Giữ 00_CONTEXT.md luôn ngắn (Project Brief 1–2 trang)](#1-giữ-00_contextmd-luôn-ngắn-project-brief-12-trang)
- [2) Tách lịch sử và quyết định ra file riêng](#2-tách-lịch-sử-và-quyết-định-ra-file-riêng-để-brief-không-phình)
- [3) Map file để agent biết phải đọc gì (P0 quan trọng nhất)](#3-map-file-để-agent-biết-phải-đọc-gì-p0-quan-trọng-nhất)
- [4) Context Compression định kỳ (nén ngữ cảnh)](#4-context-compression-định-kỳ-nén-ngữ-cảnh)
- [5) Reading budget cho agent (đọc ít nhưng đúng)](#5-reading-budget-cho-agent-đọc-ít-nhưng-đúng)
- [6) Daily HOT 15 ngày + Archive/Cô đặc (đã chốt)](#6-daily-hot-15-ngày--archivecô-đặc-đã-chốt)
- [7) "Definition of Done" cho hệ context](#7-definition-of-done-cho-hệ-context)
